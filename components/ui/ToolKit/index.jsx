...
const ToolKit = () => {
    ...
    return (
        <SectionWrapper>
            <div id="actions" className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                <div className="max-w-2xl mx-auto space-y-3 sm:text-center">
                    <h2 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                        Бъдещите възможности на приложението
                    </h2>
                </div>
                <div className="mt-12">
